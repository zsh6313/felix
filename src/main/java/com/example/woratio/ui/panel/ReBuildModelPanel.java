...
import com.example.woratio.utils.ConstantsTools;
import com.example.woratio.utils.PropertyUtil;
import com.example.woratio.utils.UiConsts;

/**
 * @filename ReBuildModelPanel
 * @description
 * @author Felix
 * @date 2020/8/14 16:35
 */
public class ReBuildModelPanel extends JPanel {
	private static final long serialVersionUID = 1L;
	private static final Logger logger = LoggerFactory.getLogger(ReBuildModelPanel.class);
	...
	public static void setContent() {
		...
		labelFrom.setText(PropertyUtil.getProperty("ds.ui.status.from") + ConstantsTools.CONFIGER.getHostFrom() + "/" + ConstantsTools.CONFIGER.getNameFrom());
	...
	private void addListener() {
		buttonStartNow.addActionListener(e -> {
			if (isRunning == false) {
				...
				ReBuildModelPanel.setContent();
				ReBuildModelPanel.progressTotal.setValue(0);
...
//			}
		...
		buttonStop.addActionListener(e -> {
			...
			ReBuildModelPanel.buttonStartNow.setEnabled(true);
			service.shutdown();
