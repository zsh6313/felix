...
public class ToolBarPanel extends JPanel {
    ...
    private static MyIconButton buttonReBuildModel;
    ...
    private void addButtion() {
        ...
        buttonReBuildModel = new MyIconButton(UiConsts.ICON_STATUS_ENABLE, UiConsts.ICON_STATUS_ENABLE,
        ...
        panelUp.add(buttonReBuildModel);
    ...
    private void addListener() {
        buttonReBuildModel.addActionListener(e -> {

            buttonReBuildModel.setIcon(UiConsts.ICON_STATUS_ENABLE);
            ...
            App.mainPanelCenter.add(App.reBuildModelPanel, BorderLayout.CENTER);
